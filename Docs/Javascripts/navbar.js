...
navbar.innerHTML = `
         <nav>
            <div class="max-w-7xl mx-auto flex justify-between items-center w-full p-5">
                ...
                <ul class="md:flex hidden items-center gap-7">
                    ...
                    <li><a href="./about-us.html" class="hover:text-[#000] transition-all duration-500">About</a>
                    </li>
                    <li><a href="./products.html" class="hover:text-[#000] transition-all duration-500">Products</a>
                    </li>
                </ul>
        ...
        <div id="mobileMenu"
            class="fixed right-0 top-0 bg-black max-w-[30rem] w-0 overflow-hidden h-screen z-50 transition-all duration-500">
            ...
            <ul class="flex relative z-50 flex-col p-10 gap-7">
                <li><a href="./index.html" class="hover:text-[#000] transition-all font-medium duration-500">Home</a>
                </li>
                <li><a href="./about-us.html"
                        class="hover:text-[#000] transition-all font-medium duration-500">About</a></li>
                <li><a href="./products.html"
                        class="hover:text-[#000] transition-all font-medium duration-500">Products</a>
                </li>
            </ul>
        </div>
`
